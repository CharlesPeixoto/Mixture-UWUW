...
legend("topright", c(expression(paste(mu,1, " = 0.2, ", mu,2, " = 0.1, ", beta,1,' = 2.5, ', beta,2,' = 2.0 ')),
                     c(expression(paste(mu,1, " = 0.4, ", mu,2, " = 0.2, ", beta,1,' = 3.0, ', beta,2,' = 2.0 ')),
                       c(expression(paste(mu,1, " = 0.5, ", mu,2, " = 0.3, ", beta,1,' = 3.1, ', beta,2,' = 2.5 ')),
                         c(expression(paste(mu,1, " = 0.6, ", mu,2, " = 0.4, ", beta,1,' = 4.0, ', beta,2,' = 5.0 ')),
                           c(expression(paste(mu,1, " = 0.7, ", mu,2, " = 0.5, ", beta,1,' = 5.0, ', beta,2,' = 5.0'))))))),
       col = c(1,2,3,4,5),
       lty= c(1,1,1,1,1),
       lwd = c(1,1,1,1,1), bty="n", cex = 0.8)
